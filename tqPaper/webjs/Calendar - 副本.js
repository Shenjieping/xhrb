...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#96c319","bg_over":"#f9f9f9","bg_out":"#96c319"}
	this.textcolor = {"Chover":"#fff"}
};
...
Calendar.prototype.draw = function() {
	...
	_cs[_cs.length] = '<table class="caleTable" id="__calendarTable" width="100%" border="0" cellpadding="3" cellspacing="1" align="center">';
	_cs[_cs.length] = ' <tr class="TrUptab">';
	_cs[_cs.length] = '  <th><input class="l" name="goPrevMonthButton" type="button" id="goPrevMonthButton" value="" \/><\/th>';
	_cs[_cs.length] = '  <th class="monwidth" colspan="5"><select class="year" name="yearSelect" id="yearSelect"><\/select><select class="month" name="monthSelect" id="monthSelect"><\/select><\/th>';
...
Calendar.prototype.bindData = function () {
	...
	for(var i = 0; i < tds.length; i++) {
		...
		tds[i].style.Color = calendar.textcolor["Chover"];
		tds[i].onclick = null;
...
Calendar.prototype.show = function (dateControl, popuControl) {
	...
	this.panel.style.left = xy.x+52 + "px";
	this.panel.style.top = (xy.y + dateControl.offsetHeight-52) + "px";
...
document.writeln('<div class="timepop" id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;width:200px;height:216px;">');
document.writeln('<iframe class="iframetime" name="__calendarIframe" id="__calendarIframe" width="100%" height="100%" scrolling="no" frameborder="0" style="margin:0px;"><\/iframe>');
...
__ci.document.writeln('<link type="text\/css" rel="stylesheet" href="webcss\/layout.css">');
